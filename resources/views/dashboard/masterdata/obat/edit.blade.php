                        ...
                        <div class="flex-1">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <select name="jenis" class="w-full select">
                                    ...
                                    <option value="tablet"
                                        {{ old('jenis', $data->jenis) == 'tablet' ? 'selected' : '' }}>Tablet
                                    </option>
                                    <option value="sirup"
                                        {{ old('jenis', $data->jenis) == 'sirup' ? 'selected' : '' }}>Sirup
                                    </option>
                                    <option value="kapsul"
                                        {{ old('jenis', $data->jenis) == 'kapsul' ? 'selected' : '' }}>Kapsul
                                    </option>
                                    <option value="salep"
                                        {{ old('jenis', $data->jenis) == 'salep' ? 'selected' : '' }}>Salep
                                    </option>
                                    <option value="injeksi"
                                        {{ old('jenis', $data->jenis) == 'injeksi' ? 'selected' : '' }}>Injeksi
                                    </option>
                                    <option value="suppositoria"
                                        {{ old('jenis', $data->jenis) == 'suppositoria' ? 'selected' : '' }}>
                                        Suppositoria</option>
                                </select>
                                @error('jenis')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    <input type="text" name="harga_beli" id="harga_beli"
                                        value="{{ old('harga_beli', $data->harga_beli) }}" class="grow"
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    <input type="text" name="harga_jual" id="harga_jual"
                                        value="{{ old('harga_jual', $data->harga_jual) }}" class="grow"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (hargaBeliInput.value) {
                hargaBeliInput.value = formatRupiah(hargaBeliInput.value);
            }
