                        ...
                        <div class="flex-1">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <input type="text" name="nama" id="nama" class="w-full input"
                                    placeholder="Nama Pasien" value="{{ old('nama') }}" disabled />
                                @error('nama')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </fieldset>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <input type="text" name="alamat" id="alamat" class="w-full input"
                                    placeholder="Alamat Pasien" value="{{ old('alamat') }}" disabled />
                                @error('alamat')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </fieldset>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <textarea name="keluhan" class="w-full input" placeholder="Keluhan" style="min-height: 100px;">{{ old('keluhan') }}</textarea>
                                @error('keluhan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </fieldset>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    ...
                                    <input type="number" name="tb" class="w-full input"
                                        placeholder="Tinggi Badan" value="{{ old('tb') }}" />
                                </label>
                                @error('tb')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    ...
                                    <input type="number" name="suhu_badan" class="w-full input"
                                        placeholder="Suhu Badan" value="{{ old('suhu_badan') }}" />
                                </label>
                                @error('suhu_badan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    ...
                                    <input type="number" name="lila" class="w-full input"
                                        placeholder="Lingkar Lengan Atas" value="{{ old('lila') }}" />
                                </label>
                                @error('lila')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div id="anc-kia-form" class="relative hidden p-4 mt-8 border border-gray-300 rounded-md">
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="date" name="hpht" class="w-full input"
                                        placeholder="Hari Pertama Haid " value="{{ old('hpht') }}" />
                                    @error('hpht')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="gpa" class="w-full input"
                                        placeholder="GPA (Gravida, Paritas, Abortus)" value="{{ old('gpa') }}" />
                                    @error('gpa')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <select name="persalinan_terakhir" class="w-full select">
                                        ...
                                        <option value="normal"
                                            {{ old('persalinan_terakhir') == 'normal' ? 'selected' : '' }}>Normal
                                        </option>
                                        <option value="caesar"
                                            {{ old('persalinan_terakhir') == 'caesar' ? 'selected' : '' }}>Caesar
                                        </option>
                                        <option value="bantuan_alat"
                                            {{ old('persalinan_terakhir') == 'bantuan_alat' ? 'selected' : '' }}>
                                            Bantuan
                                            Alat</option>
                                    </select>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="number" name="djj" class="w-full input"
                                        placeholder="DJJ (Denyut Jantung Janin/menit)" value="{{ old('djj') }}" />
                                    @error('djj')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="refla" class="w-full input"
                                        placeholder="Refla (Reflex Patella Ibu)" value="{{ old('refla') }}" />
                                    @error('refla')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="lab" class="w-full input"
                                        placeholder="Hasil lab ibu hamil" value="{{ old('lab') }}" />
                                    @error('lab')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                            ...
                            <div id="nifas-kb-form"
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <select name="bantu_persalinan" class="w-full select">
                                        ...
                                        <option value="bidan"
                                            {{ old('bantu_persalinan') == 'bidan' ? 'selected' : '' }}>
                                            Bidan</option>
                                    </select>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="cairan_keluar" class="w-full input"
                                        placeholder="Darah nifas" value="{{ old('cairan_keluar') }}" />
                                    @error('cairan_keluar')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="infeksi" class="w-full input"
                                        placeholder="Infeksi pasca lahiran" value="{{ old('infeksi') }}" />
                                    @error('infeksi')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
                            ...
                            <div id="penatalaksanaan-form"
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" name="tindakan" class="w-full input"
                                        placeholder="Tindakan yang diberikan" value="{{ old('tindakan') }}" />
                                    @error('tindakan')
                                        <span class="text-sm text-red-500">{{ $message }}</span>
                                    @enderror
                                </fieldset>
