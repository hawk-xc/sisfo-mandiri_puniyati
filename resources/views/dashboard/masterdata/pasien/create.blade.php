        ...
        <div class="shadow-xl card bg-base-100">
            <div class="card-body">
                <div id="head" class="flex flex-row justify-between">
                    <h2 class="mb-6 text-2xl font-bold card-title">Tambah : Data Pasien</h2>
                    <a href="{{ route('pasien.index') }}" class="btn btn-neutral">
                        <i class="ri-arrow-go-back-line"></i> Kembali
                    </a>
                </div>
                <div id="form-body">
                    <form action="{{ route('pasien.store') }}" method="post" class="flex flex-col gap-2 p-10">
                        @csrf
                        @method('POST')
                        ...
                        <div class="flex-1">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <input type="text" name="penanggung_jawab" class="w-full input"
                                    placeholder="Penanggung Jawab" value="{{ old('penanggung_jawab') }}" />
