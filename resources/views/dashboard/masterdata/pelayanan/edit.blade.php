                        ...
                        <div class="flex-1">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <select name="nama_pelayanan" class="w-full select" disabled>
                                    ...
                                    <option value="ibu nifas"
                                        {{ old('nama', $data->nama) == 'ibu nifas' ? 'selected' : '' }}>Ibu
                                        Nifas</option>
                                    <option value="kb" {{ old('nama', $data->nama) == 'kb' ? 'selected' : '' }}>KB
                                    </option>
                                    <option value="umum" {{ old('nama', $data->nama) == 'umum' ? 'selected' : '' }}>
                                        Umum</option>
                                </select>
                                @error('nama')
                            ...
                            <fieldset class="fieldset">
                                ...
                                <label class="w-full input">
                                    <input type="text" name="biaya" id="biaya"
                                        value="{{ old('biaya', $data->biaya) }}" class="grow"
