        ...
        <div class="shadow-xl card bg-base-100">
            <div class="card-body">
                <div id="head" class="flex flex-row justify-between">
                    <h2 class="mb-6 text-2xl font-bold card-title">Data Pendaftaran Pasien</h2>
                    <div>
                        <a href="{{ route('pendaftaran.create') }}" class="btn btn-primary btn-sm">
                            <i class="ri-add-line"></i> Tambah data
                        </a>
                        <button onclick="exportData('pendaftaran', 'pdf')" class="btn btn-outline btn-neutral btn-sm">
